...
export default function TiendaPage({ params }: { params: { tiendaId: string } }) {
    ...
    const getPrecio = (item: ObjetoTienda) => item.precio_personalizado; // Asumimos que el precio personalizado es el precio de venta
        ...
        <div className="p-8 space-y-6">
             <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} title={`Comprar ${itemToBuy?.nombre_objeto}`}>
                <div className="space-y-4">
                    ...
                    <p className="font-semibold text-right">Costo Total: {(getPrecio(itemToBuy!) || 0) * cantidad} <FaCoins className="inline text-yellow-500" /></p>
